...
const MetaMaskButton = ({ onClick }) => (
  <button
    type="button"
    className="text-gray-900  hover:bg-gray-100 font-medium rounded-lg text-lg px-5 py-2.5 text-center inline-flex items-center bg-daonative-dark-200 text-daonative-gray-200 hover:bg-daonative-dark-100 w-full h-16"
    onClick={onClick}
  >
